...
class UserAdmin(admin.ModelAdmin):
    ...
    list_display = ('get_name', 'email', 'get_date_joined', 'is_staff', 'is_superuser')
    ...
    def user_change_password(self, request, user_id, form_url=''):
        ...
        if user is None:
            raise Http404('{name} object with primary key {key} does not exist.'.format(name=force_text(self.model._meta.verbose_name), key=escape(user_id)))
